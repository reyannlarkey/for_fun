...
df = pd.read_csv('../Data/sudoku.csv', nrows = 1)


quiz = np.asarray([int(i) for i in df.quizzes.values[0]]) # convert to array of numbers
solution = np.asarray([int(i) for i in df.solutions.values[0]]) # convert to array of numbers
# print(quiz)
